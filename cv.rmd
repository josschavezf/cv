...
```{r}
if(params$pdf_mode){
  cat("View this CV online with links at [josschavezf.github.io/cv](josschavezf.github.io/cv/cv.html)")
} else {
  cat("[<i class='fas fa-download'></i> Download a PDF of this CV](https://github.com/josschavezf/cv/raw/master/cv.pdf)")
}
```
...
The source code is available [on github.com/josschavezf/cv](https://github.com/josschavezf/cv).
